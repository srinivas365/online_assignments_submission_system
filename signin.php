...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users (username, password, student) VALUES (?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sss", $param_username, $param_password,$param_student);
            
            // Set parameters
            session_start();
            $param_username = $username;
            $param_password = password_hash($password, PASSWORD_DEFAULT); // Creates a password hash
            $param_student=$_POST["student"];
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                $sql="INSERT INTO user_details(email_id) values('$profile_name')";
                if ($conn->query($sql) === FALSE) {
                    echo "Error: " . $sql . "<br>" . $conn->error;
                }   
                header("location: settings.php");
                //we need to create a folder with username
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label class="radio-inline">
                    <input type="radio" name="student" value="yes">Student
                </label>
                <label class="radio-inline">
                    <input type="radio" name="student" value="no">Teacher
                </label>
            </div>
            <div class="form-group">
